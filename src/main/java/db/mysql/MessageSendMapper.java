...
public interface MessageSendMapper {
    ...
    @Select("insert user_chat_message (send_user_id, receive_user_id, message_content, type, voiceTime)  values  (#{sendUserId},#{receiveUserid},#{messageContent},#{type},#{voiceTime})")
